...
void menu_compressao(std::string path_arquivo, bool tipo_algoritmo = false)
{
...
void menu_descompressao(std::string path_arquivo, bool tipo_algoritmo = false)
{
...
int main() {
    menu_compressao("c", false);
    menu_descompressao("c", false);
    return 0;
}